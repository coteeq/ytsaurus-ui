...
## [3.0.0](https://github.com/coteeq/ytsaurus-ui/compare/ui-v2.3.0...ui-v3.0.0) (2025-10-08)
...
* **Accounts:** add custom accounts usage base url [YTFRONT-4927] ([510587e](https://github.com/coteeq/ytsaurus-ui/commit/510587e7da13a6990e949316f1d4a74147e874ba))
* **Analytics:** create analytics factory ([9e47bdb](https://github.com/coteeq/ytsaurus-ui/commit/9e47bdb9629b3603fce6ac0ec5a1f32107aa69b7))
* **Bundles:** remove bundle balancer [YTFRONT-5160] ([7b5f141](https://github.com/coteeq/ytsaurus-ui/commit/7b5f141e9b7f3498049e2af55f8b3682c7560c77))
* **CodeAssistant:** send query error to chat [YTFRONT-5054] ([3de6250](https://github.com/coteeq/ytsaurus-ui/commit/3de62503f9920c301859731f046f74b3f8528ea2))
* **Consumer:** add register buttons for queues and consumers [YTFRONT-4869] ([f9d0a84](https://github.com/coteeq/ytsaurus-ui/commit/f9d0a843905362050fa80ddbdffeb4f5056d078f))
* **Dashboard2/Accounts:** multiple mediums setting [YTFRONT-3400] ([8cf7d07](https://github.com/coteeq/ytsaurus-ui/commit/8cf7d070a85496a4e39e9ce000281b9f6d41499d))
* **Dashboard2/Operations:** add pool setting [YTFRONT-3400] ([06e00cc](https://github.com/coteeq/ytsaurus-ui/commit/06e00ccf0cc0d3bfb1aa23877faa8a23da11c279))
* **Dashboard2/PoolsWidget:** add favourite/custom list setting [YTFRONT-3400] ([989c148](https://github.com/coteeq/ytsaurus-ui/commit/989c1480c82e05f3ca4decc46f1258457078c70f))
* **Dashboard2/Queries:** add author setting [YTFRONT-3400] ([13c99bd](https://github.com/coteeq/ytsaurus-ui/commit/13c99bd910a8a97fd970b4b8c3cc3a6763df3dd1))
* **Dashboard2/ServicesWidget:** add favourite/custom list setting [YTFRONT-3400] ([127d2c9](https://github.com/coteeq/ytsaurus-ui/commit/127d2c9e80238a0c8dae5b6552f205ca03c939cc))
* **Dashboard2:** add items count to widget header [YTFRONT-3400] ([040d913](https://github.com/coteeq/ytsaurus-ui/commit/040d913f22525a919695bff2725053feb6ba3bf9))
* **Dashboard2:** add roles and quota info links [YTFRONT-3400] ([6da78a0](https://github.com/coteeq/ytsaurus-ui/commit/6da78a0e0e0dfb8e8ba70a3ed50ac7dbfcd75f57))
* **Dashboard2:** add sizing on load [YTFRONT-3400] ([0c8beca](https://github.com/coteeq/ytsaurus-ui/commit/0c8beca7e2d4e6bb134229059660f3f5c4b1f011))
* **Dashboard2:** autoheight widget setting [YTFRONT-3400] ([2a23ae9](https://github.com/coteeq/ytsaurus-ui/commit/2a23ae9666b0e9bc08fbd59d9accdb2aae348797))
* **Dashboard2:** do not display options for not allowed services [YTFRONT-3400] ([e648b94](https://github.com/coteeq/ytsaurus-ui/commit/e648b9445bfcfa8f9ac047ee1ba5b113020ce0ea))
* **Dashboard2:** init new dashboard page [YTFRONT-3400] ([3cb7cea](https://github.com/coteeq/ytsaurus-ui/commit/3cb7cea40dc04275688c86db3093b9cdfe24b3c1))
* **Dashboard2:** internalization for Dashboard page [YTFRONT-3400] ([fdef408](https://github.com/coteeq/ytsaurus-ui/commit/fdef4081b15178d9b5255730905c1bec5cc35f0c))
* **Dashboard2:** setup accounts widget [YTFRONT-3400] ([798d61e](https://github.com/coteeq/ytsaurus-ui/commit/798d61ee7abd9ffbef9ddb642337a19676dbbfc7))
* **Dashboard2:** setup navigation widget [YTFRONT-3400] ([ea74f14](https://github.com/coteeq/ytsaurus-ui/commit/ea74f1411386764b3b63478ffd7e9976b47f0e5c))
* **Dashboard2:** setup new dashboard top row [YTFRONT-3400] ([e1cc255](https://github.com/coteeq/ytsaurus-ui/commit/e1cc2557616cc7370fd87337a6e1b1f27c967c48))
* **Dashboard2:** setup operations widget [YTFRONT-3400] ([0e712ad](https://github.com/coteeq/ytsaurus-ui/commit/0e712adc19944bdbfb04707d5dc99bf87f87598a))
* **Dashboard2:** setup pools widget [YTFRONT-3400] ([8dc1aa4](https://github.com/coteeq/ytsaurus-ui/commit/8dc1aa48d874cc59eaef82568c4befc1dc086fbb))
* **Dashboard2:** setup queries widget [YTFRONT-3400] ([35e09d2](https://github.com/coteeq/ytsaurus-ui/commit/35e09d28984a0ed410de51986da467d50b4d3a6d))
* **Dashboard2:** setup services widget [YTFRONT-3400] ([c6d2f1f](https://github.com/coteeq/ytsaurus-ui/commit/c6d2f1fdf13f116ecd50de6f19d6b2b0082fb90b))
* **Dashboard2:** setup widget on adding [YTFRONT-3400] ([967a735](https://github.com/coteeq/ytsaurus-ui/commit/967a7357f4eadbd6d5af53f887ebb4ad49dc68fd))
* **Dashboard2:** take map node icons from navigation [YTFRONT-3400] ([afb6bec](https://github.com/coteeq/ytsaurus-ui/commit/afb6becab7c36101fdd211331fac998be9e150c2))
* **Dashboard2:** update default dashboard setup [YTFRONT-3400] ([f916498](https://github.com/coteeq/ytsaurus-ui/commit/f91649856fd5f51685c5a7ec4153085997f51e61))
* **Dialog/AccountsMultiple:** add items deleting labels [YTFRONT-3400] ([44e34aa](https://github.com/coteeq/ytsaurus-ui/commit/44e34aa32bf1bf7222ab9f7fa1206cf978cc21d1))
* **Dialog/TimeDuration:** forbid all symbols except numbers and latin chars [YTFRONT-4995] ([380c4ab](https://github.com/coteeq/ytsaurus-ui/commit/380c4ab0ad8aa531c8acf3647d397301012d668c))
* **Dialog:** accounts with presets ([237ef65](https://github.com/coteeq/ytsaurus-ui/commit/237ef650f1907e9c0413dbf9d5d08e982a1150e8))
* **Dialog:** add filter for services select control [YTFRONT-5007] ([51aab9b](https://github.com/coteeq/ytsaurus-ui/commit/51aab9b249b07cedcf7039dbb13b9235c3036cd1))
* **Dialog:** add pools multiple select control ([305bb97](https://github.com/coteeq/ytsaurus-ui/commit/305bb97786180496573569012022e0e43c4b6a15))
* **Dialog:** add services select control ([f3005fa](https://github.com/coteeq/ytsaurus-ui/commit/f3005fa3bffed8d19c5bb69fb638e3a46f5273de))
* **Groups:** replace idm column to external system [YTFRONT-5113] ([75d3473](https://github.com/coteeq/ytsaurus-ui/commit/75d347388cb2d5526ceb6df8df3916f5d8daef5f))
* **Monaco:** new colors for dark and light contrast theme [YTFRONT-5060] ([a49bf9d](https://github.com/coteeq/ytsaurus-ui/commit/a49bf9d3318d36432da64cdd2a07dae5148784b5))
* **Navigation/CreateTable:** add new aggregate type [YTFRONT-5153] ([7e0ee63](https://github.com/coteeq/ytsaurus-ui/commit/7e0ee63ca4ae849e55d483709f229ad346c13aee))
* **Navigation/Description:** add external description option [YTFRONT-4680] ([dbfe196](https://github.com/coteeq/ytsaurus-ui/commit/dbfe196174aad542e6616acf5677f92edb064644))
* **Navigation/Description:** display loaded description [YTFRONT-5015] ([76fc3d3](https://github.com/coteeq/ytsaurus-ui/commit/76fc3d358db8719f350d9969d40eb575bf2836c9))
* **Navigation/Flow:** add 'force'-flag for static spec editing [YTFRONT-5185] ([26a75b6](https://github.com/coteeq/ytsaurus-ui/commit/26a75b63fdab09fe416e7372629cb33a7acf7307))
* **Navigation/Flow:** add Graph-view [YTFRONT-3978] ([12c79d9](https://github.com/coteeq/ytsaurus-ui/commit/12c79d9c1e7138863833d03d1d45b161ee8e5059))
* **Navigation/Queue:** add consumer creation [YTFRONT-4869] ([69c23f9](https://github.com/coteeq/ytsaurus-ui/commit/69c23f9e4b1cba38cf2aea3cc803cdd64eb937b9))
* **Navigation/ReplicatedTable:** add column for content_type [YTFRONT-4964] ([c9b16f3](https://github.com/coteeq/ytsaurus-ui/commit/c9b16f3763f01b0b3a67bdf46b8e09ded849c08c))
* **Navigation/Table:** inline preview for `audio`, `image` tags [YTFRONT-5022] ([b84ed7d](https://github.com/coteeq/ytsaurus-ui/commit/b84ed7d9e3c96e6a1f55e43945c8e4e5d808e373))
* **Navigation/TabletErorrs:** make error message button and expand first error [YTFRONT-4740] ([865f759](https://github.com/coteeq/ytsaurus-ui/commit/865f7598ba0ce86e9b5e8e3cb30c21f76b2aa431))
* **Navigation/TabletErrors:** remove useless url params on unmount [YTFRONT-4740] ([f755d62](https://github.com/coteeq/ytsaurus-ui/commit/f755d62e6853b8a6764f3938bef348fc51bcde80))
* **Navigation/TabletErrors:** small upgrades [YTFRONT-4740] ([e9b459b](https://github.com/coteeq/ytsaurus-ui/commit/e9b459bbdd146ba359d45f7f59a6a90b6b272fd1))
* **Navigation/UploadFileManager:** bump javascript-wrapper ([e8ed922](https://github.com/coteeq/ytsaurus-ui/commit/e8ed9228e935050c72e166f7fadd18ba8d4ec940))
* **Navigation/UploadFileManager:** change folder struct and validation ([26eb9b9](https://github.com/coteeq/ytsaurus-ui/commit/26eb9b93a7629a8ae4e77260feff1f244870c690))
* **Navigation/UploadFileManager:** use calcProgressProps ([cb71e7c](https://github.com/coteeq/ytsaurus-ui/commit/cb71e7cc280c736be383afafb9b9dd5358a2f24b))
* **Navigation/UploadFileManager:** use ping_ancestor_transactions instead of ping ([e9bde89](https://github.com/coteeq/ytsaurus-ui/commit/e9bde894077591785230e5f70b7d030dcfbe2651))
* **Navigation/UploadFileManager:** writeFile ([8826a8b](https://github.com/coteeq/ytsaurus-ui/commit/8826a8bea9a01f25020a389f6e98d025b764d0b4))
* **Navigation/YqlWidget:** qt operation link [YTFRONT-4994] ([8b9688c](https://github.com/coteeq/ytsaurus-ui/commit/8b9688c3e000716b1143cdd597b01d97944d9073))
* **Navigation:** add icons for queue producers and consumers [YTFRONT-4981] ([401465d](https://github.com/coteeq/ytsaurus-ui/commit/401465d2250ba6e893ac9b5bca20a09067869e35))
* **Navigation:** copy form types [[#1173](https://github.com/coteeq/ytsaurus-ui/issues/1173)] ([1fb65a7](https://github.com/coteeq/ytsaurus-ui/commit/1fb65a76545d016e89114c4b4fa74b24b76a9512))
* **Navigation:** reuse file upload components [[#1173](https://github.com/coteeq/ytsaurus-ui/issues/1173)] ([47752c4](https://github.com/coteeq/ytsaurus-ui/commit/47752c4a87ec05cd4db93f995fa0d33f105a817e))
* **Navigation:** Support uploading files through the UI [[#1173](https://github.com/coteeq/ytsaurus-ui/issues/1173)] ([be1c2e7](https://github.com/coteeq/ytsaurus-ui/commit/be1c2e7aff2280cfe518ce20a21487bfe9c7179f))
* **Navigation:** Support uploading files through the UI [[#1173](https://github.com/coteeq/ytsaurus-ui/issues/1173)] ([8acf29e](https://github.com/coteeq/ytsaurus-ui/commit/8acf29e863e427f247653706dd2d66119a91ca51))
* **Navigtaion/Table/MetaTable:** add description for size-items [YTFRONT-3929] ([497a717](https://github.com/coteeq/ytsaurus-ui/commit/497a71713d12f4df0e0d49524277fc272170697b))
* **Operation/Details:** error.job_id attributes should be displayed as a link [YTFRONT-3916] ([fd38edf](https://github.com/coteeq/ytsaurus-ui/commit/fd38edf1e6b11407fbd81fef146d69e2ed8f9a97))
* **Operation/Jobs:** add 'With interruption info' attribute support [YTFRONT-4810] ([02cf8ea](https://github.com/coteeq/ytsaurus-ui/commit/02cf8ea5c667c413f57579ce33e57c3134c75ab1))
* **Operation/Timeline:** show incarnations [YTFRONT-4980] ([7f3209d](https://github.com/coteeq/ytsaurus-ui/commit/7f3209d98cadd8fd15fb6a16a2919c32a7c16f84))
* **OperationDetail/Incarnations:** add incarnations tab [YTFRONT-5119] ([7f6264c](https://github.com/coteeq/ytsaurus-ui/commit/7f6264ca9e4fde6df1f37305910c88d90313cc2a))
* **Operations/Detail:** add special statuses for gpu vanilla operations [YTFRONT-4943] ([a4a6a40](https://github.com/coteeq/ytsaurus-ui/commit/a4a6a40796058c658cedf200700788612763f81f))
* **Operations/PyDLTelemetry:** add uifactory property for tab [YTFRONT-4892] ([9421322](https://github.com/coteeq/ytsaurus-ui/commit/9421322323b791538279e29ada3d3ef4d92104b9))
* **Operations/Runtime:** add absolute values [YTFRONT-5120] ([a986bd4](https://github.com/coteeq/ytsaurus-ui/commit/a986bd4796c42983ec522ffeedfb935b217dfef8))
* **Operations/Runtime:** add tooltips [YTFRONT-5120] ([a26b6e4](https://github.com/coteeq/ytsaurus-ui/commit/a26b6e41625c5963e3c604d8e76948657b77f4e8))
* **Operations:** add performance analysis system link [YTFRONT-4924] ([1bd2b69](https://github.com/coteeq/ytsaurus-ui/commit/1bd2b69ca71b8538504ce33b469d9c905e784410))
* **Operations:** change runtime meta data [YTFRONT-4940] ([db63474](https://github.com/coteeq/ytsaurus-ui/commit/db63474a5e160f2fb2207f9cb61c0c4d3c4f3cf7))
* **Operations:** jobs timeline [YTFRONT-4695] ([6f0296e](https://github.com/coteeq/ytsaurus-ui/commit/6f0296e1de33b764a2ae56f481ce33ffd23cba06))
* **Queries/List:** add additional list filters [YTFRONT-5058] ([fc5ad97](https://github.com/coteeq/ytsaurus-ui/commit/fc5ad976051beb0a6b7299e1f9cdda80ce4c7286))
* **Queries/List:** infinite query list [YTFRONT-5060] ([9a58558](https://github.com/coteeq/ytsaurus-ui/commit/9a5855808e5eb4292bf4b700df70158c44ad1a30))
* **Queries/Monaco:** scroll editor to selected line [YTFRONT-4915] ([9a747aa](https://github.com/coteeq/ytsaurus-ui/commit/9a747aae7241ad742988c54b1b645b4c3b93d1ba))
* **Queries/Navigation:** add open new tab button [YTFRONT-4985] ([4bb9786](https://github.com/coteeq/ytsaurus-ui/commit/4bb978649a4a956913dd4d585c9a399ab95fdf9b))
* **Queries/Result:** inline preview for `image`,`audio` tags  [YTFRONT-5022] ([0c400d7](https://github.com/coteeq/ytsaurus-ui/commit/0c400d73bd42396c758edf1c187604ea033a318e))
* **Queries:** add multi chart [YTFRONT-4999] ([d760704](https://github.com/coteeq/ytsaurus-ui/commit/d760704cdfa14914c019a339b872a30528a94044))
* **Queries:** add multi progress [YTFRONT-4999] ([37eb5d2](https://github.com/coteeq/ytsaurus-ui/commit/37eb5d2416ca0d1145cd43337dd5b84d8c5260b8))
* **Queries:** add secrets button [YTFRONT-5162] ([8b6a834](https://github.com/coteeq/ytsaurus-ui/commit/8b6a8342a8e2e1b3c7137ad5fc987e587ed270d5))
* **Queries:** filter engines by selected cluster [YTFRONT-4852] ([7a0daaf](https://github.com/coteeq/ytsaurus-ui/commit/7a0daaf443d186a54c2f4cb8e7f24f9646ceb425))
* **Queries:** qt menu redesign [YTFRONT-4852] ([04a5b2c](https://github.com/coteeq/ytsaurus-ui/commit/04a5b2c5387a5aec06cad5c90f9c4eadabc5af25))
* **Queries:** share query with active tab [YTFRONT-5001] ([9ea4fcb](https://github.com/coteeq/ytsaurus-ui/commit/9ea4fcba2c443463a26504825fba6cc6c2ea771e))
* **Queue/Exports:** move ms to tooltips [YTFRONT-4995] ([77010c4](https://github.com/coteeq/ytsaurus-ui/commit/77010c4c59d5361421b8845b72369eba66dc7d67))
* **Scheduling/Overview:** allow to customize columns [YTFRONT-4402] ([06d92bc](https://github.com/coteeq/ytsaurus-ui/commit/06d92bca76d61f26938b253b15f2a69e23a9ad18))
* **Scheduling:** scroll into ref operation view [YTFRONT-4941] ([237e207](https://github.com/coteeq/ytsaurus-ui/commit/237e207a04b68bf311f52d6ad3eb326ada718ff2))
* **System:** add decimal value for cell-tag [YTFRONT-4939] ([f3d53bb](https://github.com/coteeq/ytsaurus-ui/commit/f3d53bb94dc515ba6dafd3d0198fd299c34e2111))
* **TabletError:** add testing api option [YTFRONT-4740] ([9bd661d](https://github.com/coteeq/ytsaurus-ui/commit/9bd661dbd3e5c6ddced004a27622914f4c055e10))
* **UIFactory/Query:** add chat [YTFRONT-4813] ([757de1f](https://github.com/coteeq/ytsaurus-ui/commit/757de1fbbe45a0381be13e70e1ba8efe0530f1be))
* **UIFactory:** extend the UIFactory for external descriptions [YTFRONT-4680] ([7201467](https://github.com/coteeq/ytsaurus-ui/commit/7201467d87cba61c0fd5ca172fe30032d16be5eb))
* update @gravity-ui/chartkit v5.22.4 [YTFRONT-5116] ([e2b0be8](https://github.com/coteeq/ytsaurus-ui/commit/e2b0be8a721a14777784cdb6df0be86af6b715b5))
* update @ytsaurus/javascript-wrapper ([a953b63](https://github.com/coteeq/ytsaurus-ui/commit/a953b6370921e691013b74a6909906a64d2201f4))
* **Users:** replace idm column to external system [YTFRONT-5113] ([dc25858](https://github.com/coteeq/ytsaurus-ui/commit/dc258587276e1c06e6917b95e827e569f1852e61))
* **VCS:** remember user last choice [YTFRONT-4504] ([d253b09](https://github.com/coteeq/ytsaurus-ui/commit/d253b096391acb94700069dc09b6c8d00145cd3a))
* **yql:** add syntax highlighting for new YQL keywords ([ab6ff5a](https://github.com/coteeq/ytsaurus-ui/commit/ab6ff5af05eb06512ce183ebd9cce5d214c03555))


### Bug Fixes

* **Account:** normalize timestamp [YTFRONT-4913] ([76b38e1](https://github.com/coteeq/ytsaurus-ui/commit/76b38e17eb8574668ea5d4c00ec5b5434482d850))
* **Accounts/DetailedUsage:** move navigation link from path to button [YTFRONT-4896] ([27ebab3](https://github.com/coteeq/ytsaurus-ui/commit/27ebab38598675470b198f9491d43b088f1df3b8))
* **Accounts/DetailedUsage:** use all fileds of row for '/get-versioned-resource-usage' [YTFRONT-5187] ([a8e73d6](https://github.com/coteeq/ytsaurus-ui/commit/a8e73d6b57c8a939b84d83162b3a188c2b03b65f))
* **Accounts:** typo in the graphic [YTFRONT-5151] ([3a1975c](https://github.com/coteeq/ytsaurus-ui/commit/3a1975c72a1999dcbeb59f22275ac86e96de4a8a))
* **Accounts:** use recoursive_resource_usage for 'Aggregation' [YTFRONT-5024] ([a15f1a9](https://github.com/coteeq/ytsaurus-ui/commit/a15f1a906b6e0dc1ba6319998502f1aabb540d34))
* **Acl:** added "vital" param to requestPermissions call, because it is required for "Register queue consumer (vital)" permission ([c7e96a2](https://github.com/coteeq/ytsaurus-ui/commit/c7e96a2ec55af73616dc6e8aea906cf4293cf4ce))
* **ACL:** bring back `inheritAcl` field [YTFRONT-4718] ([bf0f4bc](https://github.com/coteeq/ytsaurus-ui/commit/bf0f4bc573096d7db41b54b43f84b8c25cc02122))
* **ACL:** get rid of 'mode: keep-missing-fields' [YTFRONT-5039] ([ea90bfa](https://github.com/coteeq/ytsaurus-ui/commit/ea90bfa3a927f168f3bf6da7cc4f1af684a37d32))
* **ACL:** incorrect 'Inherit ACL' value [YTFRONT-4718] ([65d1f3e](https://github.com/coteeq/ytsaurus-ui/commit/65d1f3ecc97f7739390db398def3bdd93e22664f))
* allow empty ACO for existing query ([2ee0d26](https://github.com/coteeq/ytsaurus-ui/commit/2ee0d2661d2af2dca765b386ef6fbf33a780f6db))
* always setted non-empty engine value in query-tracker [[#1150](https://github.com/coteeq/ytsaurus-ui/issues/1150)] ([2e0c35c](https://github.com/coteeq/ytsaurus-ui/commit/2e0c35cea6a4a34c32c48b54010303aa283c5424))
* **BundleEditorDialog:** minor fixes [YTFRONT-4947] ([7a7432a](https://github.com/coteeq/ytsaurus-ui/commit/7a7432a4644e809a24a75f177a64dbd26506f81a))
* **Bundles/BundleEditor:** thread pools fields should '&gt;0' [YTFRONT-4947] ([1aa4438](https://github.com/coteeq/ytsaurus-ui/commit/1aa4438ca2befb96ba9944d0fa46a53ecc371135))
* changed default value of UIFactory.onChytAliasSqlClick - now sql button is working on chyt page ([2ed97f0](https://github.com/coteeq/ytsaurus-ui/commit/2ed97f06a344eb9bfd8a2112e4c144180d0aaa5a))
* **ChaosReplicatedTable:** use `alter_table_replica` to control `enable_replicated_table_tracker` [YTFRONT-4796] ([6983439](https://github.com/coteeq/ytsaurus-ui/commit/6983439c34cc6f9536824c3aa7f5125bfdfc3ab5))
* **Chart:** yql datetime in chart [YTFRONT-4937] ([e3d692b](https://github.com/coteeq/ytsaurus-ui/commit/e3d692b0036786aace2d3fc9d87eb9f0a38565ee))
* color reassign ([aba8a7f](https://github.com/coteeq/ytsaurus-ui/commit/aba8a7fffd534817cbe809b1d80f24aca163b378))
* **ColumnSelector:** decode columns with non-english names [YTFRONT-4873] ([d9a552d](https://github.com/coteeq/ytsaurus-ui/commit/d9a552d7d7d801066d2a38abc6d665c86057f420))
* **CreateTableModal:** rename 'Queue' =&gt; 'Queue table' [YTFRONT-4953] ([50b46b1](https://github.com/coteeq/ytsaurus-ui/commit/50b46b1b59327100a3b1bf986eb5b3260978ac5f))
* **Dashboard/Settings:** dont use main config as editting in settings [YTFRONT-3400] ([aacfcdc](https://github.com/coteeq/ytsaurus-ui/commit/aacfcdc4aefac88f72dbf291c5c7ba6ea1bcb9f6))
* **Dashboard2/Accounts:** make mediums readable [YTFRONT-3400] ([4432bea](https://github.com/coteeq/ytsaurus-ui/commit/4432bea9fe9b44b913b65f41cd4ad8f19034b51d))
* **Dashboard2/Accounts:** merge column controls [YTFRONT-3400] ([d25f743](https://github.com/coteeq/ytsaurus-ui/commit/d25f743c3cc43d66bded37cb6cfeb83c0938dde4))
* **Dashboard2/Operations:** uncontrolled filter [YTFRONT-3400] ([d6e69a3](https://github.com/coteeq/ytsaurus-ui/commit/d6e69a3c7dd2cea36a9431fbf6ffb63d5ac564be))
* **Dashboard2/Operations:** uncontrolled filter [YTFRONT-3400] ([f3cdf97](https://github.com/coteeq/ytsaurus-ui/commit/f3cdf97b8d77e2c0147842a9fe0105f5fd7269c9))
* **Dashboard2/TopRow:** recolor buttons [YTFRONT-3400] ([2ccd8c8](https://github.com/coteeq/ytsaurus-ui/commit/2ccd8c84fefc82d0fab3f1ca1ad3e58ee261ee0f))
* **Dashboard2:** add limits for queries and operations [YTFRONT-3400] ([cd35267](https://github.com/coteeq/ytsaurus-ui/commit/cd35267539ec48251e27a72220960bf7ee510eee))
* **Dashboard2:** autohieght with zero items [YTFRONT-3400] ([809a8f3](https://github.com/coteeq/ytsaurus-ui/commit/809a8f32b7910dab65d5fd7b96f00cf79e042aed))
* **Dashboard2:** config editting [YTFRONT-3400] ([1d3cea1](https://github.com/coteeq/ytsaurus-ui/commit/1d3cea14ed3d82858a143c28015a64ed11fddbff))
* **Dashboard2:** copy config [YTFRONT-3400] ([b2d3bea](https://github.com/coteeq/ytsaurus-ui/commit/b2d3bea54d0e3ba86738598f3b9674483e6b32c7))
* **Dashboard2:** edit mode on cluster change [YTFRONT-3400] ([d865de5](https://github.com/coteeq/ytsaurus-ui/commit/d865de5dc83df49394fe444f4f16b053e7407d7e))
* **Dashboard2:** navigation options and rewrite oprtions selectors [YTFRONT-5007] ([815ba7f](https://github.com/coteeq/ytsaurus-ui/commit/815ba7f444e9c71a81ac2f547921243471da7869))
* **Dashboard2:** remove usable accounts from defaults and add queries author [YTFRONT-3400] ([76f0248](https://github.com/coteeq/ytsaurus-ui/commit/76f024886f1f8d22e7a0adb5a0719772314ce48f))
* **Dashboard2:** request usable accounts on cluster change [YTFRONT-3400] ([ed1efa5](https://github.com/coteeq/ytsaurus-ui/commit/ed1efa53f66cddce8c6281a638761fa929d803b5))
* **Dashboard2:** searching multiple accounts and pools on large clusters [YTFRONT-3400] ([012a578](https://github.com/coteeq/ytsaurus-ui/commit/012a578d59afacd1a63b9380a51e06c4b83b63ed))
* **Dashboard2:** zero widgets dashboard [YTFRONT-3400] ([97a0ce2](https://github.com/coteeq/ytsaurus-ui/commit/97a0ce2962130df5327fd551d53de3d01240b444))
* **Dashboard:** autohieght, typos, extra contol in operations settings, navigation fallback [YTFRONT-3400] ([3a55fc1](https://github.com/coteeq/ytsaurus-ui/commit/3a55fc1bbb1a3229c6d48d6fdbc7a30dd4395b70))
* **Dialog/AccountsMultiple:** gaps [YTFRONT-3400] ([0d2213f](https://github.com/coteeq/ytsaurus-ui/commit/0d2213f06d879fe5a15d533adfa589ad72f7b5dc))
* do not show cluster selectors in case when we have only one cluster ([01ce947](https://github.com/coteeq/ytsaurus-ui/commit/01ce947dfb86ada716ae3fb5acbc47356a77737f))
* execute batch api endpoint ([9c8df79](https://github.com/coteeq/ytsaurus-ui/commit/9c8df79e867725e86eff9c6aa62b7f61a813bee7))
* **Job:** host should be clickable [YTFRONT-4958] ([fd55fa5](https://github.com/coteeq/ytsaurus-ui/commit/fd55fa507546711be886d1be9bfa65682bb94508))
* minor fix to publish new release ([e90a68b](https://github.com/coteeq/ytsaurus-ui/commit/e90a68bbb5f165acb4c9e9b0237a3978227c01f5))
* **Modal:** close modal when pressing esc [YTFRONT-2533] ([72ddde9](https://github.com/coteeq/ytsaurus-ui/commit/72ddde9d60dbcce5c3a476896aa81b2e27b3480b))
* **Navigation/AccessLog:** add 'Recursive' checkbox filter [YTFRONT-5023] ([3e96cca](https://github.com/coteeq/ytsaurus-ui/commit/3e96cca6aac21c08008e2b9f281d0bdcbbf65ebe))
* **Navigation/ACL:** fix a mispring [YTFRONT-5166] ([85f1c06](https://github.com/coteeq/ytsaurus-ui/commit/85f1c066d0f762ddc02bfafd46676792823e7635))
* **Navigation/Consumers:** icon position in button [YTFRONT-4869] ([f59d4c5](https://github.com/coteeq/ytsaurus-ui/commit/f59d4c599a28c9e71a476db1bf7e8fd75c6e630d))
* **Navigation/Metadata:** monaco vim mode [YTFRONT-4908] ([10d4f4b](https://github.com/coteeq/ytsaurus-ui/commit/10d4f4bc333a7ae50befbbd4ffc7318cdab160dc))
* **Navigation/Queue:** add 'mapping in proggress' message [YTFRONT-4954] ([0b14083](https://github.com/coteeq/ytsaurus-ui/commit/0b1408368e944b0cfb8bca71023d17c2a08e9bdf))
* **Navigation/Queue:** use schema for Queue tab visibility [YTFRONT-5056] ([90c5b09](https://github.com/coteeq/ytsaurus-ui/commit/90c5b09be23246ea6b9e3d70d3bce8c00259833b))
* **Navigation/Table:** get rid of YAMR from Download/Upload dialogs [YTFRONT-3982] ([e33b5b1](https://github.com/coteeq/ytsaurus-ui/commit/e33b5b1dfdb9c8a3e00905e7307e6a1410a3d31a))
* **Navigation/Tablets:** arrow click [YTFRONT-5030] ([044d0ae](https://github.com/coteeq/ytsaurus-ui/commit/044d0ae66d7fa10970ee46b9186cb770a4f83e33))
* **Navigation/Table:** use getInitialSettingsData from reducers [YTFRONT-5137] ([a94a549](https://github.com/coteeq/ytsaurus-ui/commit/a94a54986e2b409adbdce0440d7f902a2dcf84ad))
* **Navigation/UploadFileManager:** reset state after closing and shift menu item ([b7ac155](https://github.com/coteeq/ytsaurus-ui/commit/b7ac155abd41fd6dfedbfebb4b7a8923aa22be7b))
* **Navigation:** fix cancellation ([cfa5d83](https://github.com/coteeq/ytsaurus-ui/commit/cfa5d836e6acb247a54cc19842b15706e073489f))
* **Navigation:** now renderNodeIcon is called with correct argument ([9d4bc5a](https://github.com/coteeq/ytsaurus-ui/commit/9d4bc5a8e2f75497b799ab8fe9fc71438c0b89d5))
* **Navigation:** table virtualization problem [YTFRONT-5074] ([cf81b6f](https://github.com/coteeq/ytsaurus-ui/commit/cf81b6fca8f34fa3f04d2cbf9f2e2abed86f3651))
* **Operation/Details/Tasks:** add 'Hide empty' filter to "Aborted statistics" dialog [YTFRONT-5012] ([4a55020](https://github.com/coteeq/ytsaurus-ui/commit/4a550206c57eab90ef5456f7b8e5e8e88639e9c8))
* **Operation/Details:** edit button should be always visible [YTFRONT-5164] ([658a55a](https://github.com/coteeq/ytsaurus-ui/commit/658a55a28fb5b1a04f43038395ebea62715f3e39))
* **Operation/Details:** move to bottom Alerts/Tasks section from 'vanilla' operations in gpu-trees [YTFRONT-4961] ([d1ba329](https://github.com/coteeq/ytsaurus-ui/commit/d1ba329448d5c43c29bc3fafa52f6a8dfef748a2))
* **Operation/Details:** set default limit for visible count of env/layers [YTFRONT-4962] ([29a1217](https://github.com/coteeq/ytsaurus-ui/commit/29a12172d24a478aa943b52248c030a06f76ae23))
* **Operation/Jobs:** do not allow to collapse 'Id/Address' column [YTFRONT-5171] ([0fb04a9](https://github.com/coteeq/ytsaurus-ui/commit/0fb04a912c4d4a255a9efe161aa94962d920a736))
* **Operation/LivePreview:** fix for 'n.map is not a function ...' [YTFRONT-5021] ([71fda06](https://github.com/coteeq/ytsaurus-ui/commit/71fda06115b2375d389ff33b847243ccb27b8de8))
* **Operation:** do not display 'Data flow' for 'vanilla' [YTFRONT-4959] ([50c8a1f](https://github.com/coteeq/ytsaurus-ui/commit/50c8a1f6a01198fc652e91680b33d09c488a9d37))
* **Operation:** do not show 'total job wall time'/'total cpu time spent' for 'vanilla' [YTFRONT-4960] ([4d9dec9](https://github.com/coteeq/ytsaurus-ui/commit/4d9dec9b02b87807aba8cebeff9c43756f8577c7))
* **Operations/Detail:** special status tooltip [YTFRONT-4943] ([7405792](https://github.com/coteeq/ytsaurus-ui/commit/7405792875fe57cff6a4cfd30199f480f96262ba))
* **Operations/JobsMonitoring:** full list of descriptors [YTFRONT-5192] ([8a3c244](https://github.com/coteeq/ytsaurus-ui/commit/8a3c24477092f8a8af1f2b74d8c33cdfb10a53f2))
* **Operations:** dont show special status instead of suspended [YTFRONT-5035] ([f305463](https://github.com/coteeq/ytsaurus-ui/commit/f305463f731c89afbd5e0b5ac5253303f1fb2940))
* **Operations:** utf8 parsing problem [YTFRONT-4982] ([cdece79](https://github.com/coteeq/ytsaurus-ui/commit/cdece798e4e92e2dd98bfea41d8f5aecc84ef8ef))
* **Operation:** utf8 error in description [YTFRONT-4982] ([f60f965](https://github.com/coteeq/ytsaurus-ui/commit/f60f965ddc6fd4c8d4756cc3fd66b12849edc2e6))
* PathEditor component will not corrupt hotkeys scope anymore [[#1160](https://github.com/coteeq/ytsaurus-ui/issues/1160)] ([cfd7a74](https://github.com/coteeq/ytsaurus-ui/commit/cfd7a740ee69a41309185b567df8747c05910386))
* **PathEditor:** bring back onBlur callback ([dea479b](https://github.com/coteeq/ytsaurus-ui/commit/dea479be18178a9f6a891f75f1fc027fffa61c9a))
* **Queries/Chart:** date in axis [YTFRONT-5105] ([52378f1](https://github.com/coteeq/ytsaurus-ui/commit/52378f1bc7f09c4591faefc92d1e00fb688d649d))
* **Queries/List:** incorrect order of elements when starting a query [YTFRONT-4770] ([f3a59a3](https://github.com/coteeq/ytsaurus-ui/commit/f3a59a3b907ef8e860d83d96fe5a1feec613cb82))
* **Queries/Navigation:** correct element icons [YTFRONT-5099] ([7e64c6d](https://github.com/coteeq/ytsaurus-ui/commit/7e64c6da3096eb4efb8ddffbcb6a0febb81727d3))
* **Queries/Result:** result tab priority [YTFRONT-5122] ([6d83a4b](https://github.com/coteeq/ytsaurus-ui/commit/6d83a4be1b9cff4291312250a8c4817c1b041bc0))
* **Queries/Result:** result tab priority [YTFRONT-5122] ([153313f](https://github.com/coteeq/ytsaurus-ui/commit/153313f7ecfbb92aa07a2d6f8bf2ab50e63d664e))
* **Queries/Share:** changed dependency on list query [YTFRONT-4770] ([bbb62f7](https://github.com/coteeq/ytsaurus-ui/commit/bbb62f79708b60ce3ff1745fdf5fee0623a18c32))
* **Queries:** fix excel download link ([912dc1e](https://github.com/coteeq/ytsaurus-ui/commit/912dc1ef7a87db854c0c858facb02de554bbb9b4))
* **Queries:** list queries filter debounce [YTFRONT-5059] ([aa208df](https://github.com/coteeq/ytsaurus-ui/commit/aa208df0ab412276988c30b0124a77e07a67ff46))
* **Queries:** monaco scroll [YTFRONT-5091] ([1918dd2](https://github.com/coteeq/ytsaurus-ui/commit/1918dd2028089b176c27004fbcc74c8ba691e89a))
* **Queries:** multiple paths in one line [YTFRONT-4920] ([a143785](https://github.com/coteeq/ytsaurus-ui/commit/a1437853104a3c15e481a5ec278bfadcabb78340))
* **Queries:** query result full view [YTFRONT-5071] ([1b340e7](https://github.com/coteeq/ytsaurus-ui/commit/1b340e73c13ed996c38fabb4cbd4dd14c90ba0ee))
* **Queries:** wrong clique selector size [YTFRONT-5227] ([db610ec](https://github.com/coteeq/ytsaurus-ui/commit/db610ec8fcd8a22296a4cb864a11412e2465b7ac))
* **Queue/Exports:** export duration validator [YTFRONT-4995] ([462525c](https://github.com/coteeq/ytsaurus-ui/commit/462525c7da3a959794f6feac7dc0724ba2efd44d))
* **Scheduling:** display 'Automatically calculated' only for pools [YTFRONT-3812] ([a2b80d3](https://github.com/coteeq/ytsaurus-ui/commit/a2b80d3abb37c5565ffe0faf43143cb1d7d85dec))
* **Scheduling:** use 'estimated_guarantee_resources' instead of 'promised_fair_share_resources' [YTFRONT-4015] ([4031d70](https://github.com/coteeq/ytsaurus-ui/commit/4031d70961dc27b9697ef5d7170d4b8b427afe22))
* **Scheduling:** use fifo_index as sort column for FIFO-pool by default [YTFRONT-4942] ([422ffe7](https://github.com/coteeq/ytsaurus-ui/commit/422ffe7f50afdcbb169fe971a7502fd14f72281f))
* **Timeline:** from to error [YTFRONT-5011] ([b58e037](https://github.com/coteeq/ytsaurus-ui/commit/b58e0376e88ff9af6d0afceb6debbec5a16a3ccf))
* **UTF8:** encoding table schema [YTFRONT-5161] ([ded51be](https://github.com/coteeq/ytsaurus-ui/commit/ded51be9fbe5c26ed78caa69d6bde785bcf09510))
* **UTF8:** truncated cell encoding [YTFRONT-5206] ([69f44f7](https://github.com/coteeq/ytsaurus-ui/commit/69f44f78f9c7d941d0ec13729ebfa03b88399903))
* **UTF8:** truncated modal [YTFRONT-5202] ([a64ede7](https://github.com/coteeq/ytsaurus-ui/commit/a64ede7cc6ba11635e6a4c523e594583d1f09f29))
* widgets adding ([2d8a988](https://github.com/coteeq/ytsaurus-ui/commit/2d8a98890af464951cd98112f65b602b0cd4d7be))


### Code Refactoring

* **interface-helpers:** move format.DateTime to ui/src/common/hammer/format [YTFRONT-5171] ([53721f4](https://github.com/coteeq/ytsaurus-ui/commit/53721f4c0e9c81d41070d5ebc0240e5402be0427))
...
* The following workspace dependencies were updated
  * dependencies
    * @ytsaurus/javascript-wrapper bumped from ^0.14.0 to ^0.15.0
  * devDependencies
    * @ytsaurus/interface-helpers bumped from ^1.0.2 to ^2.0.0
